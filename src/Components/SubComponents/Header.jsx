  ...
  return (
    <header className=" my-32 md:mt-52 text-center  " >
        <div >
            ...
            <motion.h1  initial="hidden" animate="show" variants={headerSlide} className='text-xl md:text-2xl font-extrabold spectral text-orange-400  '>WANT TO GO ABROAD FOR HIGHER <br /> EDUCATION ?</motion.h1>
            <motion.p initial={{ opacity:0   }} animate={{opacity:1 , transition:{delay:1}}} className='leading-5 text-sm font-bold text-gray-300' >
